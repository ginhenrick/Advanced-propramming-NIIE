...
class Fee():
    def __init__(self, master):
        ...
        self.lblTitle = Label(Title_Frame, font=('arial', 40, 'bold'), text='Student Management System',
        ...
        # ===================================================Labels================================================
        self.recpt_label = Label(Frame_1, text='Full Name : ', font=(
            'arial', 14, 'bold'), bg='Navajo white')
        self.recpt_label.grid(row=0, column=0, padx=15, sticky=W)

        self.name_label = Label(Frame_1, text='Class Name : ', font=(
            'arial', 14, 'bold'), bg='Navajo white')
        self.name_label.grid(row=1, column=0, padx=15, sticky=W)

        self.admsn_label = Label(Frame_1, text='Studen Id : ', font=(
            'arial', 14, 'bold'), bg='Navajo white')
        ...
        self.branch_label = Label(Frame_1, text='Subject : ', font=(
            'arial', 14, 'bold'), bg='Navajo white')
        self.branch_label.grid(row=4, column=0, padx=15, sticky=W)

        self.sem_label = Label(Frame_1, text='Mark : ', font=(
            'arial', 14, 'bold'), bg='Navajo white')
